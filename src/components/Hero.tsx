  ...
  return (
    <div className="hero bg-transparent min-h-screen">
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        />
        <div>
          <h1 className="text-7xl font-extralight">Andrei Stefan</h1>
          ...
          <button className="btn btn-primary mr-5">Contact Me!</button>

          <button className="btn btn-neutral">Browse Projects</button>
        </div>
      </div>
    </div>
  );

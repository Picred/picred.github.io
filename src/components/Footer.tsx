export const Footer = () => {
    return (
        <footer className="sticky footer bg-neutral text-neutral-content items-center lg:justify-between justify-center gap-2 p-4">

            <aside className="flex flex-col lg:flex-row lg:grid-flow-col items-center font-bold text-md lg:text-lg italic">
                <svg width="36" height="36" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" className="fill-current hidden ">
                    <path d="M21,22H46.8A3.2,3.2,0,0,0,50,18.8v-.49A4.33,4.33,0,0,0,45.69,14H18.31A4.33,4.33,0,0,0,14,18.31V45.69A4.33,4.33,0,0,0,18.31,50H45.69A4.33,4.33,0,0,0,50,45.69V27"
                ...
                <p> Made with ❤️ by Andrei Stefan </p>
                    <a href="https://github.com/Picred/picred.github.io" className="underline link link-hover link-success">
                        Code on GitHub
                    </a>
            </aside>
